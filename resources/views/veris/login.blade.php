...
<!-- /Logo -->
<form id="formAuthentication" class="mb-3" action="/empresarial/login" method="POST">
    @csrf
    <div class="my-3">
        <div class="alert alert-primary fs--3">
            <p class="mb-0">Estimado Usuario, para loguearse debes usar tus credenciales PhantomX.</p>
        </div>
    </div>
